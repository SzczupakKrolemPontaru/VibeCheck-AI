...
import com.example.vibecheckai.enums.EmotionComparator;
import com.example.vibecheckai.enums.EmotionsEnum;
import com.example.vibecheckai.enums.SentimentComparator;
...
public class YouTubeVideoService {
    ...
    public YouTubeAnalysisResponseDTO analyzeVideo(String videoLink) {
        ...
        try {
            ...
            throw new InvalidYouTubeLinkException("Invalid YouTube video link: " + videoLink);
        }
        ...
        YouTubeAnalysisVideoStatistics videoStatistics;
